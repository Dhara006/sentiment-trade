...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-4QMMEFXK.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-4QMMEFXK.js")).default(client, args);
    case "add":
      return (await import("./add-RFEOV2UA.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-PSP2JIOP.js")).default(client, args);
    case "rm":
      return (await import("./rm-MRY3IJAA.js")).default(client, args);
    case "update":
      return (await import("./update-IDQ343BY.js")).default(client, args);
    default:
